...
FastAttackLoL/refs/heads/main/FastAttack.lua"))()----------------------------------------------------//------------------------------------------------------// PATH 
wait(1)
...
local Sea_Left = Tab.Tab_Sea:addSection()--// SEA FARM
local Sea_Farm = Sea_Left:addMenu('#Sea Event')--// TWEEN BOATS
...
local Subs_Farm_Right = Tab.Tab_SubFarm:addSection()--// MATERIAL FARM
...
1328.8309326171875))
Vector3.new(30,30,30)-1328.8309326171875))
...
CDK_Quest_Puzzle:addLabel("Will Released Soon")----------------------------------------------------//------------------------------------------------------// Other Quest
...
7783.1860351563))-7783.1860351563))
7675.4892578125))
7675.4892578125) - 
                            else
...
8.43218029e-09, -0.983064115))
                ...
                Tween(CFrame.new(-8652.99707, 143.450119, 6170.50879, -0.983064115,-2.48005533e-10, 0.18326205, -1.78910387e-09, 1, -8.24392288e-09, -0.18326205, 
8.43218029e-09, -0.983064115))
            end
            wait(2)
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("gravestoneEvent",
...
local Raid_Left = Tab.Tab_4:addSection()--// Law Raid
...
local Misc_Left = Tab.Tab_7:addSection()----------------------------------------------------//------------------------------------------------------// MISC RIGHT
