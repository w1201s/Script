...
local cfg = {
    ...
    shieldheadchance = 100, -- percent chance to hit head instead of shield (0-100)
    ...
    distancebasedhitchance = true, -- use distance breakpoints to change hitchance
    ...
    autograbdelay = 0, -- how long the item must stay nearby before grabbing
